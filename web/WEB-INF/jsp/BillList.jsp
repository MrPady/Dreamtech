    ...
    <div class="middle" style="margin-left: auto; margin-right: auto; vertical-align:middle;text-align:center;">
        <table>
            <tr>
                ...
                <th style="padding-left: 10px; width: 200px">金额</th>
                <th style="padding-left: 10px; width: 200px">时间</th>
                <th style="padding-left: 10px; width: 200px">详情</th>
                <th>&nbsp;</th>
            </tr>
            <c:forEach items="${bills}" var="bill">
            <tr>
                <td>${bill.id}</td>
                <td style="padding-left: 10px ;width: 200px">${bill.money}</td>
                <td style="padding-left: 10px; width: 200px">${bill.timeString}</td>
                <td style="padding-left: 10px; width: 300px">${bill.detail}</td>
                <td style="padding-left: 10px"><a href="/deleteBill/${bill.id}">删除</a></td>
            </tr>
            </c:forEach>
            <a href="/addBill">添加</a>
    </div>
